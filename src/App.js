...
function App() {
  ...
  const [city, setCity] = useState(""); // Default to empty string
  ...
  useEffect(() => {
    const loadCountries = async () => {
      ...
      let arr = response.data.map((element) => element.name.official);
      setCountries(arr);
    };
